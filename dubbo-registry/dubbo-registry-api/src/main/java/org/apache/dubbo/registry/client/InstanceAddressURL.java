...
public class InstanceAddressURL extends URL {
    ...
    public String getServiceMethodParameter(String protocolServiceKey, String method, String key) {
        ...
        String value = serviceInfo.getMethodParameter(method, key, null); // 获取<dubbo:method/>中的loadbalance属性值
        if (StringUtils.isNotEmpty(value)) {
            return value;
        }
        return getParameter(key);  // 获取<dubbo:reference/>中的loadbalance属性值
    }
